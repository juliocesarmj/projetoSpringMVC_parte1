package br.com.juliocesarmj.repositories;
...
import br.com.juliocesarmj.interfaces.IFuncionarioRepository;
...
public class FuncionarioRepository implements IFuncionarioRepository {
	...
	public void update(Funcionario entity) throws Exception {
		...
		String sql = "update funcionario set nome = ?, cpf = ?, matricula = ?, dataadmissao = ?, situacao = ? where idfuncionario = ?";
